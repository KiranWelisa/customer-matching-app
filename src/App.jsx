...
Generated by Welisa Smart Customer Matching${useAI ? ' (AI-Powered)' : ''}`;
  ...
  const buildAIInsightsSection = (aiInsight) => {
    if (!aiInsight) return '';
    let section = '\n   🚀 AI Insights:';
    if (aiInsight.strategicFit) {
      section += `\n   • Strategic Fit: ${aiInsight.strategicFit.toUpperCase()}`;
    }
    if (aiInsight.conversionProbability) {
      section += `\n   • Conversion Probability: ${aiInsight.conversionProbability.toUpperCase()}`;
    }
